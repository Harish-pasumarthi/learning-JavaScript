...
//   console.log(textInArr);
//   for (const i of textInArr) {
//     const indexText = i.indexOf('_') + 1;
//     const camelText = i[indexText].toUpperCase(); //camel first letter untadhi
//     const replacedText = i
//       .replace('_', '')
